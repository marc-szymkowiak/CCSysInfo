# CCInfoDemo
Just a quick demonstation of how to use configcats' feature flags to control features in the application


By activation the set feature in the ConfigCats Dashboard, you can enable the view of network informations:
